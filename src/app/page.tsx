  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-center px-20 lg:px-80">
          <Image
            src="/empty.png"
            alt="Prázdná miska"
            width={1280}
            height={687}
            className="max-w-[50wv]"
          />
        </div>

        <div className="text-center mt-12 text-amber-600 text-xl font-bold">
          <p>Už nic nezbylo. Hledejte jinde.</p>
        </div>
      </div>
    </div>
  );
